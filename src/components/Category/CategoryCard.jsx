            ...
            <div onMouseEnter={() => setSelectCard(true)} onMouseLeave={() => setSelectCard(false)} className={style.categoryCard}>
                {!selectSvg ? (
                    <svg onClick={() => {
                        ...
                        const updatedClickedIds = selectSvg
                        ? clickedIdFavorite.filter(id => id !== good.id)
                        : [...clickedIdFavorite, good.id];
                        dispatch(setClickedIdFavorite(updatedClickedIds));
                        dispatch(setFavouriteCount(updatedClickedIds.length));
